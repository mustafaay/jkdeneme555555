...
//        String password = "Techpro_@126";
     ...
     */
    public static List<Integer> getColumnDataInteger(String query, String column) {
        executeQuery(query);
        ...
        try {
            rsmd = resultSet.getMetaData();
            while (resultSet.next()) {
                rowList.add(resultSet.getInt(column));
            }
        } catch (SQLException e) {
            // TODO Auto-generated catch block
            e.printStackTrace();
    ...
    public static int getMaxCountryId (String query,String column){
        int max = 0;
        List<Integer> allIds = getColumnDataInteger(query, column);
